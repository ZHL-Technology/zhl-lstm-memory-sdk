...
只要 `zhl-memory-core` 仍是 pure Python，Ubuntu、Raspberry Pi 和 RK3588 使用同一个 project version 和 package tag。未来如果加入原生平台构建，应从同一个 source tag 发布，并在 [Platform Guide](PLATFORMS.md) 中说明。
